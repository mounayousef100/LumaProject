...
public class Base {
	...
	/*
	 * public void takeScreenshot(String testName ,WebDriver driver) throws
	 * Exception{ File scrShot
	 * =((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE); String
	 * DestFilePath =
	 * System.getProperty("user.dir")+".//screenshots//"+testName+".png";
	 * FileUtils.copyFile(scrShot,new File( DestFilePath )); // return DestFilePath
	 * ; }
	 */
